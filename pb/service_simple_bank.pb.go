...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x15rpc_update_user.proto\x1a\x14rpc_login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xa2\x03\n" +
	"\n" +
	"SimpleBank\x12\x8c\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"O\x92A2\x12\x0fCreate new user\x1a\x1fUse this API to create new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\x84\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"G\x92A*\x12\vUpdate user\x1a\x1bUse this API to update user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12~\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"D\x92A(\x12\n" +
	"Login user\x1a\x1aUse this API to login user\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userB\x88\x01\x92Ah\x12f\n" +
	"\x0fSimple bank API\"N\n" +
	"\bPersonal\x12'https://github.com/javurekv/simple-bank\x1a\x19javurek.vitaliy@gmail.com2\x031.1Z\x1bsimple_bank.sqlc.dev/app/pbb\x06proto3"
