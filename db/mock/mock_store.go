...
func (m *MockStore) AddAccountsBalance(ctx context.Context, arg db.AddAccountsBalanceParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAccountsBalance", ctx, arg)
...
func (mr *MockStoreMockRecorder) AddAccountsBalance(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddAccountsBalance", reflect.TypeOf((*MockStore)(nil).AddAccountsBalance), ctx, arg)
}
